...
etiketlenenKişi.roles.remove(ayarlar.kadınRol3)
...
.setColor("RANDOM")
.setDescription(`Kullanıcının ismi \`${ayarlar.tag} ${isim} ${yaş}\` olarak değiştirildi ve <@&${ayarlar.erkekRol1}>, <@&${ayarlar.erkekRol2}>, <@&${ayarlar.erkekRol3}> rolleri verildi!`)
