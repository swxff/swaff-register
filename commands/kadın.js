...
etiketlenenKişi.roles.remove(ayarlar.erkekRol3)
...
.setColor("RANDOM")
.setDescription(`Kullanıcının ismi \`${ayarlar.tag} ${isim} ${yaş}\` olarak değiştirildi ve <@&${ayarlar.kadınRol1}>, <@&${ayarlar.kadınRol2}>, <@&${ayarlar.kadınRol3}> rolleri verildi!`)
